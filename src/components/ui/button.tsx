  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom HelpDesk variants
        hero: "bg-gradient-to-r from-primary to-accent text-primary-foreground button-glow hover:opacity-90 transform hover:scale-[1.02]",
        nav: "text-muted-foreground hover:text-foreground transition-colors",
        cta: "bg-primary text-primary-foreground button-glow hover:bg-primary/90 font-bold",
      },
      size: {
